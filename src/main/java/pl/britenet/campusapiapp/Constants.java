...
public class Constants {
    ...
    public static final String COMMAND_NAME_GET = "get";
    public static final String COMMAND_NAME_GETALL = "getall";
    public static final String COMMAND_NAME_INSERT = "insert";
    ...
    public static final String TABLE_NAME_ORDERPRODUCT = "orderproduct";
